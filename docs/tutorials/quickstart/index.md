...
A short, visual tour of the viewer for first-time users. For full reference detail, see [Visualizing Data in the CellxState/OPS Viewer](visualization.md).
...
![Default two-panel viewer layout: left control panel with Gene Knockouts and tabs, right visualization area with embedding and images panels](../assets/images/Default_-_Layout_Tab.png)
...
![Left panel with top region showing search and gene knockouts selected; bottom region with tabs for layout, annotations, and gene expression](../assets/images/Main_Panel_-_Annotations_-_Gene_KOs.png)
...
![Add Visualization sidebar showing three options with buttons for Embedding, Images, Volcano Plot](../assets/images/Add_Visualization__Embedding.png)

A **··· menu** in the top-right of the left panel opens collection-level actions: **View collection details** or **Download collection**.

![Three-dot overflow menu open showing View collection details and Download collection options](../assets/images/Collection_Overflow_Menu.png)
...
![Multi-panel view with all four panel types visible at once: OPS UMAP, OPS volcano, CROP-seq UMAP, CROP-seq gene expression volcano](../assets/images/Visualizations_-_Color_By_On,_Interactions.png)
